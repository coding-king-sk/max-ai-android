...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideDb(app: android.app.Application): AppDatabase = AppDatabase.getInstance(app)

    @Provides
    @Singleton
    fun providePrefs(app: android.app.Application): UserPreferences = UserPreferences(app)
