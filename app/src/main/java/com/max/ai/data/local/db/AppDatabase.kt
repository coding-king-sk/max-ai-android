...
import com.max.ai.data.local.entity.MemoryEntity; import com.max.ai.data.local.entity.NoteEntity; import com.max.ai.data.local.entity.CommandLogEntity
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        fun getInstance(c: Context): AppDatabase = I ?: synchronized(this) { Room.databaseBuilder(c.applicationContext, AppDatabase::class.java, "max_ai_db").fallbackToDestructiveMigration().build().also { I = it } }
    }
}