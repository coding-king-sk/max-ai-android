...
@AndroidEntryPoint class MainActivity : ComponentActivity() {
    override fun onCreate(s: Bundle?) {
        super.onCreate(s)
        setContent { MaxTheme { Surface(Modifier.fillMaxSize(), Bg) { MaxNavGraph({ startService(Intent(this@MainActivity, com.max.ai.services.MaxForegroundService::class.java)) }) } } }
    }
}
